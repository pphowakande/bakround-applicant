...
class EmployerJobApp extends React.Component {
    ...
    getCandidates(callback = null) {
        ...
        let employer_job_id = this.state.job_id;

    	let _this = this;
        this.setState({loading: true});
        return Networking.json("POST", `/employer/job/${employer_job_id}/candidates_list`, query)
                  .then(response => {
            _this.setState({
                ...
                <div>
                    <div style={{display: 'flex', alignItems: "center", justifyContent: 'space-between', width: "100%"}}>
                        <h5 style={{ fontSize: 36, marginBottom: 10, display: "flex", alignItems: "center" }}>
                            ...
                            <div style={{marginLeft: "15px" }}>
                                <a className="waves-effect waves-light btn btn-primary"
                                   href={`/employer/search/${this.state.job_id}`}
                        ...
                        <a id="export_candidates_link"
                           ...
                           href={`/employer/csv_export/${this.state.job_id}`}>Export Interested Candidates</a>
                    </div>
